...
if (!adress) {
  ...
  geocode(adress, (error, { latitude, longitude, location } = {}) => {
    //Passing in 'Philadelphia', gives geo cordinests, becouse it won't give any errors. For testing perpouses swoping 'Philadelphia' for  'abcd1234' will make the adress fail, becouse its undefined.
    if (error) {
